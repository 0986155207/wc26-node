...
const STAGE_VI = {
  GROUP_STAGE: 'Vòng bảng', LAST_32: 'Vòng 1/16', LAST_16: 'Vòng 1/8',
    ...
    await q`
      INSERT INTO matches
        (id, date_utc, stage, group_name, home, away,
         home_goals, away_goals, status, venue, city, attendance, updated_at)
      VALUES
        (${m.id}, ${m.dateUTC}, ${m.stage}, ${m.group}, ${m.home}, ${m.away},
         ${m.homeGoals}, ${m.awayGoals}, ${m.status},
         ${m.venue}, ${m.city}, ${m.attendance}, now())
